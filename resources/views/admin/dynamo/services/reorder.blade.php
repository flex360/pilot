            ...
            <div class="col-12 col-lg-11 col-xl-10">
                <div class="card sidebar-card">
                    <div class="card-header">
                        Reorder Services In This Category
                        <a href="/" target="_blank" id="preview-btn" class="btn btn-info btn-sm float-right"><i class="fa fa-eye"></i> Preview</a>
                        <a href="/pilot/servicecategory" class="btn btn-primary btn-sm float-right" style="margin-right: 10px;">Back to Service Categories</a>
                    ...
                    <div class="card-body">
                        ...
                        <input type="hidden" id="servicecategoryID" name="servicecategoryID" value="{{ $serviceCategory->id }}">
                        ...
                        @else
                            <p>Drag-n-drop sort the Services in the order you'd
                            like them to appear inside this ServiceCategory.
                            Click the "Preview" button and a new tab will open up to that category.
                            You can re-order the Services again, and refresh the Preview tab until you get the order the way you
                            want it.</p>
                                            ...
                                            @foreach ($items as $item)
                                                <tr class="dynamo-index-row" data-id="{{ $item->id }}">
                                                  <td><i class="fas fa-bars fa-2x"></i></td>
                                                    ...
                                                    <td>{!! $item->getDescriptionBackend() !!}</td>
                                                    <td>
...
@section('scripts')
    <script src="/pilot-assets/legacy/js/servicecategory-services.js"></script>
    <script>
    $(document).ready(function(){
        ...
        var previewUrl = '/services/' + categoryNumber + '/category';
